<template>
    <div class="container">
      ...
      <div class="content" v-else>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 565 535" style="width: 565px; height: 535px;">
          <path v-for="path in pathsData" :key="path.id" :d="path.d" class="cls-1"
                :id="path.id" @mouseover="handleMouseOver(path)" @mouseleave="handleMouseLeave">
